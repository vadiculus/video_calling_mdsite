    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_time', models.IntegerField(default=60, validators=[django.core.validators.MaxValueValidator(240), django.core.validators.MinValueValidator(20)])),
                ('time_end', models.DateTimeField(blank=True, null=True, verbose_name='Конечное время')),
